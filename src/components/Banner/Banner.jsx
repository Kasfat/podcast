...
const Banner = () => {
  return (
    <div className=' relative mt-6'>
        <img src={BannerImage} alt="Banner" className="w-full h-[300px]" />
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-[#007182] from-18.4%">
            <div className='px-8 flex flex-col mt-10 gap-4'>
